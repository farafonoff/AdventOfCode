...
function decode(str,n) {
  ...
  return carr.map(ch=>{
    ...
    return String.fromCharCode(chc);
  }).join('')
}

function make_checksum(str) {
  var chars = str.split('');
  var charmap = []
  chars.forEach(function(c,idx) 
                {
                  charmap[c] = charmap[c]!=null?charmap[c]+1:1;
                });
  var arr = []
  for(var key in charmap) {
    arr.push({char: key, count: charmap[key]})
  }
  var sorted = arr.sort((tup1,tup2)=>{
    if (tup1.count!=tup2.count) {
                        return tup2.count-tup1.count;
    } else {
      return tup1.char < tup2.char ? -1 : tup1.char > tup2.char;
    }}
  ).slice(0,5);
  var res = sorted.map((k)=>k.char).join('')
  return res;
}

var ids = lines.map(function(elt, idx) {
  var parts = elt.match(regex);
  if (parts==null) {
    return 0;
  }
  var letters = parts[1];
  ...
  sletters = letters.replace(/-/g, '');
  var cs = make_checksum(sletters)
  if (cs===checksum) {
    console.log(decode(letters,id)+' '+id)
    return id;
  } else {
  }
  return 0;
...
var ans = ids.reduce((s,elt,i)=>s+elt,0)

ans

function short_input() {
...
/*
Exception: TypeError: checksum is not a function
@Scratchpad/1:30:12
@Scratchpad/1:21:1
*/
/*
...
*/
/*
Exception: ReferenceError: chamap is not defined
make_checksum/<@Scratchpad/1:17:20
make_checksum@Scratchpad/1:17:3
@Scratchpad/1:32:12
@Scratchpad/1:23:1
*/
/*
...
*/
/*
Exception: TypeError: input is undefined
@Scratchpad/2:11:5
*/
/*
Exception: TypeError: input is undefined
...
*/
/*
Exception: ReferenceError: str1 is not defined
make_checksum/sorted<@Scratchpad/2:29:7
make_checksum@Scratchpad/2:25:16
ids<@Scratchpad/2:45:12
@Scratchpad/2:36:11
*/
/*
