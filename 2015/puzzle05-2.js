...
function build_pats() {
  ...
  for(ai in al) {
    var ch = al[ai];
    pats_1.push(new RegExp(ch+"."+ch,"g"));
    for(ai1 in al) {
      var ch1 = al[ai1];
      pats_2.push(new RegExp(ch+ch1,"g"));
    }
  }
}
...
/*
Exception: ReferenceError: pats_2 is not defined
check1@Scratchpad/2:37:3
is_good@Scratchpad/2:60:11
result<@Scratchpad/2:64:40
@Scratchpad/2:64:14
*/